...
| 날짜       | 프로젝트                     | 설명                                             | 스택                  | 깃허브<br>링크                                                                      | 참여<br>인원 |
| ---------- | ---------------------------- | ------------------------------------------------ | --------------------- | ----------------------------------------------------------------------------------- | ------------ |
| 24. 09. 27 |Automating DB Data Dump<br>& Migration | DB 데이터를 덤프화해서<br>Crontab으로 Docker<br>컨테이너 간 마이그레이션<br>자동화 | VMware, Linux,<br>Docker, MySQL | [Click👆🏻](https://github.com/2oo1s/TIL/blob/main/Hands-On/Data_Dump.md) | 1명          |
