...
| 날짜       | 프로젝트                     | 설명                                             | 스택                  | 깃허브<br>링크                                                                      | 참여<br>인원 |
| ---------- | ---------------------------- | ------------------------------------------------ | --------------------- | ----------------------------------------------------------------------------------- | ------------ |
| 24. 10. 02 | Deploying Multiple<br>Pods in k8s| k8s에서 다중 인스턴스를 배포하여<br>트래픽 로드밸런싱 | Linux, Docker, k8s | [Click👆🏻](https://github.com/2oo1s/TIL/blob/main/Hands-On/k8s_Deployment_And_LoadBalancing.md) | 1명          |
| 24. 09. 27 |Automating DB Data<br>Dump & Migration | DB 데이터를 덤프화해서<br>Crontab으로 Docker<br>컨테이너 간 마이그레이션<br>자동화 | Linux, Docker, MySQL | [Click👆🏻](https://github.com/2oo1s/TIL/blob/main/Hands-On/Data_Dump.md) | 1명          |
